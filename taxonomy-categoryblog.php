...
<div class="blog blog-category">
    ...
    <div class="blog-hero">
        <div class="container">
            <div class="row">
                ...
                <div class="offset-md-1 col-md-10">
                    <div class="blog-hero__title-cat">Blog</div>
                </div>
                <div class="offset-md-1 col-md-10">
                    <div class="blog-hero__info blog-hero__info-category">
                        <div class="blog-hero__info__title"><?php single_cat_title(); ?><Sup class="blog-category__category-view__info__number">   <?php echo $category->count; ?></Sup></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="blog-category__entries">
        <div class="container">
            <div class="row">
                <div class="offset-md-1 col-md-10">
                    <div class="blog-category__entries__container">
                        <?php while (have_posts()) : the_post(); ?>
                            <div class="blog-category__entries__container__post-item">
